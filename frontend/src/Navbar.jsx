...
const Navbar = () => {
  ...
  return (
    <div className="w-full">
      <nav
        ref={navRef}
        className="relative z-20 bg-slate-900/80 backdrop-blur-sm border-b border-slate-700 sticky top-0"
      >
            ...
            <div className="hidden lg:flex items-center space-x-6">
              {isAuthenticated ? (
                <>
                  <Link
                    to="/form"
                    className="h-9 px-4 py-2 bg-slate-800 text-slate-200 hover:bg-slate-700 inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors"
                  >
                    Parse PDF
                  </Link>
                  <button
            ...
            <div className="px-4 py-4 space-y-3">
              {isAuthenticated ? (
                <>
                  <Link
                    to="/form"
                    className="block w-full text-left px-4 py-2 bg-slate-800 text-white hover:bg-slate-700 rounded-md text-sm"
                  >
                    Parse PDF
                  </Link>
                  <button

...
export function WobbleCardDemo() {
  return (
    <div id="about" className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full overflow-y-hidden p-2">
      <WobbleCard
      ...
      >
        <div className="max-w-sm">
          ...
          <p className="mt-4 max-w-[26rem] text-left  text-base/6 text-neutral-200">
            Upload any PDF and receive a quick overview with key FAQs. Great for
            saving time on reports, manuals, or papers.
          </p>
        </div>
        <img
          src="/ss2.jpg"
